  ...
  module React
    class ReactGenerator
      ...
      def generate_component_file(name, jsx_content, json)
        ...
        # Generate viewModel-based props interface and signature
        props_interface = generate_viewmodel_props_interface(name)
        props_sig = '{ viewModel }'
      ...
      # Generate TypeScript interface for viewModel-based props
      def generate_viewmodel_props_interface(name)
        <<~TS
